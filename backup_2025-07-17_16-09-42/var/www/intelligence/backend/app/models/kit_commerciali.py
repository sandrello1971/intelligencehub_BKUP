...
class KitCommerciale(Base):
    ...
    prezzo_totale = Column(DECIMAL(10, 2))  # Mantenuto per compatibilità DB
    sconto_percentuale = Column(DECIMAL(5, 2), default=0)  # Mantenuto per compatibilità DB
...
class KitArticolo(Base):
    ...
    prezzo_unitario = Column(DECIMAL(10, 2))  # Mantenuto per compatibilità DB
